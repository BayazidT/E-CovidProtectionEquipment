                 ...
                 while($result = $qResult->fetch_assoc()){
                  $pid = $result['pid'];
                   ...
                   ?>
                     ...
                     <td> <a href="../../pages/forms/updateProduct.php?pid=<?php echo $pid; ?>" >Edit </a>||<a style="color:red;" onclick="return confirm('Are you sure to delete ?')"href="?deletePId=<?php echo $pid; ?>" > Delete</a></td>
<?php
