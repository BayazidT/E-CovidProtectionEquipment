        ...
        <div class="row">
          ...
          <div class="card">
              ...
              <script>
                ...
                <h3 class="card-title" onclick="print()">  Customer Information</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <?php
  ...
  <?php
               ...
               if($qResult)
               {
                 while($result = $qResult->fetch_assoc()){
                   ...
                   $pname = $result['pname'];
                   $pcompany = $result['pprice'];
                   $psize = $result['psize'];
                   $pcategory = $result['pcategory'];
                   $pprice = $result['pquantity'];
                   ...
                   ?>
                     ...
                     <td> <a href="../../pages/forms/updateProduct.php?pid=<?php echo $pid; ?>" >Details </a>||<a style="color:red;" onclick="return confirm('Are you sure to delete ?')"href="?deletePId=<?php echo $pid; ?>" > Delete</a></td>
<?php
